...
urlpatterns = [
    # Dashboard overview
    path('progress/summary/', views.dashboard_overview, name='dashboard_overview'),
    path('progress/metrics/', views.ProgressEntryListCreateView.as_view(), name='progress_metrics'),
    
    # User profile
    path('profile/', views.user_profile, name='user_profile'),
    
    # Progress tracking
    path('progress/entries/', views.ProgressEntryListCreateView.as_view(), name='progress_list_create'),
